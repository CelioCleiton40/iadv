          ...
          <form className="p-6 md:p-8 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Bem-vindo de volta</h1>
                <p className="text-balance text-slate-600 dark:text-slate-400">
                  Acesse sua conta do escritório
                </p>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-sm text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 underline-offset-2 hover:underline"
                  >
                    Esqueceu sua senha?
                  </a>
                </div>
                <Input id="password" type="password" required className="border-slate-200 dark:border-slate-800" />
              </div>
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-slate-200 dark:after:border-slate-800">
                <span className="relative z-10 bg-white dark:bg-slate-900 px-2 text-slate-600 dark:text-slate-400">
                  Ou continue com
                </span>
              </div>
              ...
              <div className="text-center text-sm text-slate-600 dark:text-slate-400">
                Não tem uma conta?{" "}
                <a href="/register" className="text-slate-800 dark:text-slate-200 underline underline-offset-4 hover:text-slate-900 dark:hover:text-white">
                  Cadastre-se
                </a>
              </div>
            </div>
