          ...
          <div className="relative pt-10 pb-16 sm:pt-16 sm:pb-24 lg:pt-24 lg:pb-32">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                ...
                >
                  A plataforma completa para profissionais do Direito que buscam
                  excelência. Gerencie processos, prazos, clientes e documentos
                  com inteligência e eficiência em uma única solução.
                </motion.p>
                ...
                >
                  <div className="flex -space-x-1 overflow-hidden">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className={`inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-slate-800 bg-blue-${
                          i * 100 + 200
                        }`}
                      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-slate-600 dark:text-slate-400">
              Desenvolvido para transformar a gestão jurídica.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="mt-4 max-w-3xl mx-auto">
              <p className="text-xl text-slate-600 dark:text-slate-400">
                Histórias reais de advogados que transformaram seus escritórios
                com o iAdv Manager
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              {
                quote:
                  "O iAdv Manager revolucionou a gestão do meu escritório. Economizo horas todos os dias com a automação de tarefas repetitivas.",
              ...
              {
                quote:
                  "A melhor solução para gestão de processos que já utilizei. Interface intuitiva e suporte excepcional quando precisei de ajuda.",
              ...
              {
                quote:
                  "Desde que implementamos o iAdv Manager, nunca mais perdemos um prazo processual. A ferramenta é indispensável para nosso escritório.",
          ...
          >
            ...
            <p className="text-blue-100 mb-8">
              Fique por dentro das últimas atualizações, dicas e recursos para
              otimizar seu escritório
            </p>
            <form
            ...
            >
              <input
                ...
                required
                autoComplete="email"
                aria-label="Insira seu e-mail para inscrição"
              />
              <Button
                size="lg"
                className="bg-white text-blue-600 hover:bg-blue-50 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700 px-8"
              >
                Inscrever-se
              </Button>
            </form>
