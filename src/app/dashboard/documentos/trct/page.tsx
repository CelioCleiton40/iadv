...
export default function TermoRescisaoPage() {
  // Renomeando para evitar conflito com o nome do componente refatorado
            ...
            <Card className="p-6 space-y-4">
              ...
              <div>
                <div className="flex justify-between">
                  ...
                  <p>{formatCurrency(totalProventos.toString())}</p>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between font-bold text-lg">
                  ...
                  <p className="text-blue-600 dark:text-blue-400">
                    {formatCurrency(valorLiquido.toString())}
                  </p>
                </div>
              </div>
              <Button
